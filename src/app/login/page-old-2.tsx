                ...
                <div className="relative z-10 flex flex-col justify-center items-start px-20 text-white max-w-2xl mx-auto">
                    ...
                    <div className="mb-12">
                        ...
                        <p className="text-lg text-white/90 leading-relaxed max-w-lg">
                            Kelola kegiatan Anda dengan mudah. Tingkatkan produktivitas melalui otomatisasi dan hemat banyak waktu!
                        </p>
                    </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8">
                        <h2 className="text-4xl font-bold text-gray-900 mb-4">
                            {isOtpStep ? 'Verifikasi OTP' : 'Selamat Datang Kembali!'}
                        </h2>
                            ...
                            {isOtpStep 
                                ...
                                : (
                                    <>
                                        ...
                                        , GRATIS! Hanya butuh kurang dari satu menit.
                                    </>
                                )
                            }
                        </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            {isLoading 
                                ...
                                : (isOtpStep ? 'Verifikasi OTP' : 'Masuk Sekarang')
                            }
                        </Button>
                        ...
                        {!isOtpStep && (
                            <div className="text-center">
                                ...
                                >
                                    Lupa kata sandi? <span className="font-semibold">Klik di sini</span>
                                </Link>
                            </div>
                        )}
                    </form>
