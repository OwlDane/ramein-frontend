...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center px-6 py-6 lg:py-12 bg-white">
        <div className="w-full max-w-md max-h-[calc(100vh-3rem)] overflow-y-auto custom-scrollbar">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-muted-foreground leading-relaxed">
              ...
              . For more information about Ramein&apos;s privacy practices, see
              the{" "}
              <Link
                href="/privacy"
                className="text-primary hover:text-primary/80"
        ...
        <div className="relative z-10 flex flex-col justify-center items-start px-20 text-white max-w-2xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-white/90 leading-relaxed max-w-lg">
              Discover amazing events, earn certificates, and connect with a vibrant community. Start your journey today!
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Find events that interest you</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Get recognized for participation</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/70">Connect with like-minded people</p>
              </div>
            </div>
          </div>
