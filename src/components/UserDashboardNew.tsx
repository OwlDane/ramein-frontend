  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-purple-500/5 blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-blue-500/3 blur-3xl animate-pulse"
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Kelola event dan sertifikat Anda
              </p>
            </div>
          ...
          <motion.div variants={itemVariants}>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                >
                  <Card
                    className={`relative overflow-hidden border-border/60 bg-gradient-to-br ${stat.bgGradient} backdrop-blur-sm hover:shadow-xl transition-all duration-300`}
                  >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              <TabsList className="grid w-full grid-cols-3 h-14 bg-muted/50 rounded-2xl p-1 backdrop-blur-sm">
                <TabsTrigger
                  value="overview"
                  className="rounded-xl data-[state=active]:bg-background data-[state=active]:shadow-md transition-all"
                >
      ...
      <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Kelola preferensi akun Anda</DialogDescription>
          </DialogHeader>
