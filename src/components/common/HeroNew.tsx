...
export function HeroNew({ onViewEvents }: HeroNewProps) {
    // Placeholder images - will be replaced with actual event images later
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-background pt-24 pb-16 px-4">
            <div className="container mx-auto max-w-7xl">
                ...
                >
                    ...
                    >
                        Discover and join amazing events that match your interests.
                        Create unforgettable memories with Ramein.
                    </motion.p>
