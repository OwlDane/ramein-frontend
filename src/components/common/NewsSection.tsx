  ...
  const newsItems: NewsItem[] = [
    {
      ...
      excerpt:
        "Discover strategies to maximize your virtual event experience and build meaningful connections online.",
    ...
    },
    {
      ...
      excerpt:
        "Explore the latest trends shaping the event industry and what to expect in the coming year.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how events can foster strong communities and create lasting relationships among participants.",
      category: "Community",
      readTime: "6 min read",
      image:
