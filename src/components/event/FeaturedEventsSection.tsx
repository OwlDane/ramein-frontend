...
export function FeaturedEventsSection({ onViewEvents }: FeaturedEventsSectionProps) {
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                            Your Story,{' '}
                            <span className="italic">Our Stage</span>
                        </h2>
                                ...
                                >
                                    <div className="relative h-[400px] rounded-3xl overflow-hidden bg-gradient-to-br from-muted to-accent">
                                        ...
                                        <div className="absolute inset-0">
                                            <img
                                                src={event.flyer || `https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=600&h=600&fit=crop&seed=${event.id}`}
                                                alt={event.title}
                                        ...
                                        <div className="absolute inset-0 p-6 flex flex-col justify-end">
                                            ...
                                            >
                                                <div className="flex items-center gap-2 text-xs font-medium">
                                                    ...
                                                    <span>{event.date ? format(new Date(event.date), 'MMM dd') : 'TBA'}</span>
                                                </div>
                                            </motion.div>
