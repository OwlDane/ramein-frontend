              ...
              <div className="relative p-6 overflow-y-auto max-h-[calc(85vh-120px)] bg-gradient-to-b from-transparent to-muted/20">
                <div className="space-y-4">
                  ...
                  <div className="p-5 rounded-2xl bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20">
                    <h3 className="text-lg font-bold mb-2 flex items-center gap-2">
                      <span className="w-8 h-8 rounded-lg bg-primary/20 flex items-center justify-center text-sm font-bold">
                        📧
                      </span>
                      Contact Us
                    </h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-b border-border pb-6">
                    ...
                    <p className="text-muted-foreground">
                      To register for an event, simply browse our events
                      catalog, select the event you&apos;re interested in, and
                      click the &quot;Register Now&quot; button. You&apos;ll
                      need to create an account or log in if you haven&apos;t
                      already. Follow the registration steps and complete the
                      payment if required.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-border pb-6">
                    ...
                    <p className="text-muted-foreground">
                      Cancellation policies vary by event. Please check the
                      specific event&apos;s cancellation policy before
                      registering. Generally, you can cancel your registration
                      through your dashboard. Refunds, if applicable, will be
                      processed according to the event organizer&apos;s policy.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-border pb-6">
                    <h3 className="text-lg font-bold mb-2">
                      How do I get my event ticket or confirmation?
                    </h3>
                    <p className="text-muted-foreground">
                      After successful registration, you&apos;ll receive a
                      confirmation email with your event details and a unique
                      registration token. You can also access your tickets
                      anytime from your dashboard. Make sure to bring your token
                      or confirmation email to the event.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-border pb-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      cards, bank transfers, and digital wallets. The available
                      payment options will be displayed during the checkout
                      process. All payments are processed securely through our
                  ...
                  <div className="border-b border-border pb-6">
                    <h3 className="text-lg font-bold mb-2">
                      How do I mark my attendance at an event?
                    </h3>
                    <p className="text-muted-foreground">
                      Once you&apos;re registered for an event, you&apos;ll
                      receive a unique attendance token. At the event venue, you
                      can use this token to mark your attendance through the
                      &quot;Fill Attendance&quot; button in your dashboard or by
                      providing it to the event organizer.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-border pb-6">
                    ...
                    <p className="text-muted-foreground">
                      Registration transfers depend on the event
                      organizer&apos;s policy. Some events allow transfers while
                      others don&apos;t. Please contact the event organizer
                      directly through the event page or reach out to our
                  ...
                  <div className="pb-6">
                    <h3 className="text-lg font-bold mb-2">
                      I didn&apos;t receive my confirmation email. What should I
                      do?
                    </h3>
                    <p className="text-muted-foreground">
                      First, check your spam or junk folder. If you still
                      can&apos;t find it, log in to your dashboard where you can
                      view all your registered events and download your
                      confirmation. If the issue persists, contact our support
